...
init -1 python hide:
    ...
    style.window.left_padding = 95
    style.window.right_padding = 60
    style.window.top_padding = 500
...
init -1 python hide:
    ...
    style.say_label.ypos = -20
    style.say_label.xpos = -30
...
init python:
    ...
    build.directory_name = "missing_stars-1.0"
    
    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "missing_stars"
